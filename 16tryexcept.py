...
def calc(val):
    ...
    # 예외가 발생되지 않았을때 실행되는 블럭
        ...
        print('에러없음★')
    # try로 진입했을 때 예외발생과 상관없이 무조건 실행되는 블럭
    finally:
        print('sum', sum)
...
try:
    ...
    if x % 3 != 0:
        # 예외발생시 (JAVA에서의 throw 대신) raise를 사용
    ...
    try:
        ...
        for su in range(2, end_su):
            for dan in range(1,10):
                print("%2d * %2d = %2d" % (su, dan, dan*su), end=' ')
            print()
        print()
    except Exception as e:
        print('예외발생', e)
